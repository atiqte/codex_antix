...
# Gate 15: preserve the accepted Gate 14 evidence, identity-stop only its
# retained process, clean-build the stronger address-copy feedback refinement,
# validate it only on localhost:8876, and retain it for final GUI review. Real
# addresses and Message-IDs stay private and are never printed to the log.
G13_REPO=/home/atiq/orca/workspaces/codex_antix/branch-codex
G13_COMMIT=71251c4e6809d443b2e312dfd25edc06ad8c98da
...
G13_CANDIDATE_ROOT="$G13_STATE_ROOT/multisource-strong-copy-feedback-candidate"
G13_POINTER="$G13_STATE_ROOT/multisource-strong-copy-feedback-candidate-current.env"
G13_LOG_ROOT=/mail/Logs/notmuch-browser/multisource-strong-copy-feedback-candidate
G13_BUILD_SCRIPT="$G13_REPO/scripts/notmuch_browser_build.sh"
G13_GATE14_BATCH="$G13_REPO/docs/validation/notmuch-browser-multisource/batches/14-compact-address-copy-candidate-clean-build-and-isolated-validation.sh"
G13_GATE14_LOG="$G13_REPO/docs/validation/notmuch-browser-multisource/logs/14-compact-address-copy-candidate-clean-build-and-isolated-validation.log"
G13_GATE14_RECORD="$G13_REPO/docs/validation/notmuch-browser-multisource/records/14-compact-address-copy-candidate-clean-build-and-isolated-validation.env"
G13_GATE14_POINTER="$G13_STATE_ROOT/multisource-compact-address-copy-candidate-current.env"
G13_GATE14_BATCH_SHA=dc915b9410e65d79ed310c888cb3fdb047d61e59b4d6cc118f4fd42e9cd8b8ba
G13_GATE14_LOG_SHA=e2c0b3d91cdbabc232c031715d5054e47863368deeac722215247b66053c582f
G13_GATE14_RECORD_SHA=273efb0e7a3b660c6ce5a615f36bb97cea939fa0546430be9a14ccc24c699871
G13_GATE14_POINTER_SHA=0fcdeffb2cf5ae13f4b745558e17198bba1a10a7f15c806e79aa1887a4b9c837
G13_GATE14_COMMIT=df6aac67f681722241337a59bced6db15aa42a53
G13_GATE14_CANDIDATE_SHA=c53c95e28989c3d9543394c8142b7b2fb199f8ebe4cbf28e13923a0444ab0692
...
printf '%s\n' 'gate=15-strong-address-copy-feedback-candidate-clean-build-and-isolated-validation'
...
printf '%s\n' 'authorized_gate_14_candidate_identity_stop=yes'
...
g13_equal gate_14_batch_sha256 \
  "$(sha256sum "$G13_GATE14_BATCH" | awk '{print $1}')" "$G13_GATE14_BATCH_SHA"
g13_equal gate_14_log_sha256 \
  "$(sha256sum "$G13_GATE14_LOG" | awk '{print $1}')" "$G13_GATE14_LOG_SHA"
g13_equal gate_14_record_sha256 \
  "$(sha256sum "$G13_GATE14_RECORD" | awk '{print $1}')" "$G13_GATE14_RECORD_SHA"
grep -Fqx result=success "$G13_GATE14_RECORD" ||
  g13_die "Gate 14 result is not success"
grep -Fqx privacy_review=automated_and_manual_passed "$G13_GATE14_RECORD" ||
  g13_die "Gate 14 privacy review is incomplete"
g13_equal gate_14_pointer_sha256 \
  "$(sha256sum "$G13_GATE14_POINTER" | awk '{print $1}')" "$G13_GATE14_POINTER_SHA"
g13_equal gate_14_pointer_mode "$(stat -c '%a' "$G13_GATE14_POINTER")" 600
g13_equal gate_14_pointer_status \
  "$(g13_pointer_value "$G13_GATE14_POINTER" status)" retained_for_gui_review
g13_equal gate_14_pointer_commit \
  "$(g13_pointer_value "$G13_GATE14_POINTER" repository_commit)" "$G13_GATE14_COMMIT"
g13_equal gate_14_pointer_addr \
  "$(g13_pointer_value "$G13_GATE14_POINTER" addr)" 127.0.0.1:8876
g13_equal gate_14_pointer_binary_sha256 \
  "$(g13_pointer_value "$G13_GATE14_POINTER" binary_sha256)" "$G13_GATE14_CANDIDATE_SHA"
G13_GATE14_BINARY=$(g13_pointer_value "$G13_GATE14_POINTER" binary)
[[ -f "$G13_GATE14_BINARY" ]] || g13_die "Gate 14 candidate binary is missing"
g13_equal gate_14_binary_sha256 \
  "$(sha256sum "$G13_GATE14_BINARY" | awk '{print $1}')" "$G13_GATE14_CANDIDATE_SHA"
G13_CURRENT_BOOT_ID=$(sed -n '1p' /proc/sys/kernel/random/boot_id)
G13_GATE14_BOOT_ID=$(g13_pointer_value "$G13_GATE14_POINTER" boot_id)
G13_GATE14_PID=$(g13_pointer_value "$G13_GATE14_POINTER" pid)
G13_GATE14_START_TICKS=$(g13_pointer_value "$G13_GATE14_POINTER" start_ticks)
g13_equal gate_14_pointer_boot_id "$G13_GATE14_BOOT_ID" "$G13_CURRENT_BOOT_ID"
[[ "$G13_GATE14_PID" =~ ^[0-9]+$ && -d "/proc/$G13_GATE14_PID" ]] ||
  g13_die "Gate 14 retained process is not running"
g13_equal gate_14_process_executable \
  "$(readlink -f "/proc/$G13_GATE14_PID/exe")" "$G13_GATE14_BINARY"
g13_equal gate_14_process_start_ticks \
  "$(awk '{print $22}' "/proc/$G13_GATE14_PID/stat")" "$G13_GATE14_START_TICKS"
g13_equal gate_14_port_8876_listener_count \
  "$(ss -H -ltnp 'sport = :8876' | grep -F "pid=$G13_GATE14_PID," | wc -l | tr -d ' ')" 1
G13_GATE14_HEALTH=$(curl --silent --show-error --fail --max-time 10 \
  http://127.0.0.1:8876/healthz)
g13_health_to_safe_lines gate_14_before_stop "$G13_GATE14_HEALTH"
printf '%s\n' gate_14_automated_and_antix_gui_acceptance_evidence=verified
kill "$G13_GATE14_PID"
for _ in $(seq 1 100); do
  [[ ! -d "/proc/$G13_GATE14_PID" ]] && break
  sleep 0.1
done
[[ ! -d "/proc/$G13_GATE14_PID" ]] ||
  g13_die "Gate 14 candidate did not stop after SIGTERM"
g13_equal gate_14_port_8876_listeners_after_stop \
  "$(ss -H -ltnp 'sport = :8876' | wc -l | tr -d ' ')" 0
printf '%s\n' gate_14_candidate_identity_stopped=yes
printf '%s\n' gate_14_files_and_pointer_preserved=yes
...
[[ ! -e "$G13_POINTER" ]] || g13_die "Gate 15 candidate pointer already exists"
[[ ! -e "$G13_CANDIDATE_ROOT" ]] || g13_die "Gate 15 candidate root already exists"
...
curl --silent --show-error --fail --max-time 20 \
  ...
  http://127.0.0.1:8876/static/app.js
g13_equal candidate_served_js_sha256 \
  "$(sha256sum "$G13_EVIDENCE/app.js" | awk '{print $1}')" "$G13_JS_SHA"
g13_equal candidate_served_js_bytes \
...
printf '%s\n' candidate_served_copy_feedback_timer_contract=pass
...
G13_POINTER_TMP=$(mktemp "$G13_STATE_ROOT/.multisource-strong-copy-feedback-candidate.XXXXXX")
{
...
printf '%s\n' status=gate_15_strong_address_copy_feedback_candidate_clean_build_and_isolated_validation_pass
