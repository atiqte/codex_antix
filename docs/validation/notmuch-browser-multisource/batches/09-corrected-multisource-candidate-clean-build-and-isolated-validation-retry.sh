...
# Gate 09: retry the clean build and retain the multi-source candidate on
# localhost:8876 after pinning Gate 08's quote-escaping failure evidence.
G8_REPO=/home/atiq/orca/workspaces/codex_antix/branch-codex
G8_COMMIT=ada360107f45ef3a16eb1174e570a5bb8a286e84
...
G8_CANDIDATE_SHA=a87276c5c17936489fe8ccad4de80eec3ba79cadb466ed2260825cdf4b5d19d6
...
printf '%s\n' 'gate=09-corrected-multisource-candidate-clean-build-and-isolated-validation-retry'
...
[[ ! -e "$G8_CANDIDATE_ROOT" ]] || g8_die "multi-source candidate root already exists"
...
printf '%s\n' status=gate_09_corrected_multisource_candidate_clean_build_and_isolated_validation_retry_pass
