...
# Gate 08: clean-build and retain the multi-source candidate on localhost:8876.
G8_REPO=/home/atiq/orca/workspaces/codex_antix/branch-codex
G8_COMMIT=a83eb8ec409c3ce8b4b65e00c1c3d8fb3cd609a9
...
printf '%s\n' 'gate=08-multisource-candidate-clean-build-and-isolated-validation'
...
printf '%s\n' status=gate_08_multisource_candidate_clean_build_and_isolated_validation_pass
