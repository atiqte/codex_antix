...
- [ ] Obtain antiX and Windows GUI acceptance for the retained Gate 12 candidate: source selection, single-message/newest-first results, non-overlapping date/sender layout, fixed full-message sidebar at top/middle/bottom scroll positions, date boundaries, and the existing full browser feature set.
