...
- [ ] Complete self-contained Body Images Chunk 2B FIX3 from the verified extraction after the launcher made self-patching FIX2 inapplicable; run tests/vet/build, install and resolve Inter/Aporetic, and reprove production unchanged.
