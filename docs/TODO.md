...
- [ ] Complete Body Images Chunk 2B FIX1 from the verified extraction after correcting the harness-only `go 1.25` versus `go 1.25.0` assertion; run tests/vet/build, install and resolve Inter/Aporetic, and reprove production unchanged.
