...
- [ ] Transfer only replacement bundle `d9943dfe...` to antiX, independently verify/build it, and repeat isolated real ten-CID rendering plus attachment/font/spacing validation before any production backup or install.
