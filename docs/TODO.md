...
- [ ] Independently verify/extract/test/vet/build replacement bundle `d9943dfe...` on antiX, then repeat isolated real ten-CID rendering plus attachment/font/spacing validation before any production backup or install.
