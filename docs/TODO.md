...
- [ ] Run and review an isolated clean-archive dependency/generation/test/build gate in the ignored project-local operator workspace; do not stop, install, or replace production.
