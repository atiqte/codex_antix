...
- [ ] Start only retained candidate `c7d14e0e...` on loopback 8876 with isolated project-local temp/log, run automated HTTP/HTMX/CSP/static/message checks, and retain it only after every assertion passes.
