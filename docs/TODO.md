...
- [ ] Complete Body Images Chunk 2B FIX2 from the verified extraction after correcting both harness-only literals (`go 1.25.0` and the production SHA256 typo); run tests/vet/build, install and resolve Inter/Aporetic, and reprove production unchanged.
