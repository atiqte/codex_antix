...
- [ ] Run a separate identity-bound post-cutover audit, strict browser read-only proof, resource observation, controlled service restart, and reboot/login-independent supervision gates before regenerating the final guides.
