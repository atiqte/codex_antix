...
- [ ] Run the exact `f12882ab...` temporary binary on isolated `127.0.0.1:8876`; prove a concurrent ten-CID burst returns ten image successes with zero 429 responses, then complete attachment/font/spacing/manual rendering validation before any production backup or install.
