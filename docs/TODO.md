...
- [ ] Manually validate the retained combined-migration candidate on antiX at `http://127.0.0.1:8876/`, then run an identity-bound post-review gate before any stop, cleanup, backup, install, or runit action.
