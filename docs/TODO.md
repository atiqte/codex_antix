...
- [ ] Run, review, privacy-record, commit, and push Gate 13: bind the reboot-stale Gate 12 evidence, clean-build the address-link candidate on localhost 8876, and repeat source/date/security/read-only/production-isolation checks.
