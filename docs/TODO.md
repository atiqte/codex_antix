...
- [ ] Restart exact candidate `c7d14e0e...` on loopback 8876 after preserving and auditing the reboot-stale runtime evidence, repeat the automated gate under fresh identity-bound paths, and retain it for reviewed antiX GUI validation.
