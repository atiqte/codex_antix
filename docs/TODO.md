...
- [ ] Rebuild and retain the responsive-layout plus sticky-sidebar candidate in Gate 12, then obtain antiX and Windows GUI acceptance for source selection, single-message/newest-first results, non-overlapping date/sender layout, fixed full-message sidebar, date boundaries, and the existing full browser feature set.
