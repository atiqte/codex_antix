...
- [ ] Manually browser-validate the Go notmuch service on antiX: `tag:inbox` search, single-message view, HTML iframe rendering, attachment-name display, duplicate selector, and Status page.
