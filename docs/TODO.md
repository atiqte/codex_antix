...
- [ ] Run two-part Body Images Chunk 3 FIX2/FIX3: start and retain a detached exact server on 8876 without stdin, collect the owner's manual result through Codex, then post-validate and clean up from a private pointer.
