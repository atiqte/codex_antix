...
- [ ] Gracefully stop only the exact retained candidate after final identity checks, preserve all runtime/build evidence without deleting anything, and reprove unchanged production plus free port 8876.
