...
- [ ] Run and review the corrected project-local read-only preflight using exact full command-line and executable identity before preparing any staging or build gate.
